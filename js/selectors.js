$(document).ready(function(){
  ...
  $('.Header 1').addClass('pinky');
  $('.Header 2').addClass('pinky');
  $('.Header 3').addClass('pinky');
  $('.Header 4').addClass('pinky');
  $('.Header 5').addClass('pinky');
  $('.Header 6').addClass('pinky');

  // 2.) Select all <li> inside of <ol> only and apply the class of pinky using addClass method.
  $('.Crayon').addClass('pinky');
  $('.Pencil').addClass('pinky');
  $('.Stapler').addClass('pinky');
